...
<li class="header-list__item form cursor-pointer">
...
</ul>`;window.addEventListener("DOMContentLoaded",()=>{let e;const t=document.querySelector(".footer-academy img");function a(){e=document.querySelector("body").offsetWidth,t&&(768<e?t.src="../img/logo-footer.png":t.src="../img/htmlAcademyMobile.png")}function s(e){e.stopPropagation(),e.preventDefault(),(e.clipboardData||window.clipboardData).getData("Text")}a(),window.onresize=a;var i=window.location.pathname;let l=document.querySelector("html"),c=document.querySelector(".mobile-nav");var o=document.querySelector(".desktop-nav");c.innerHTML=templatesNavMobile,o.innerHTML=templatesNav;let n=document.querySelector(".hamburger"),r=(n.onclick=function(){c.classList.toggle("is-active"),n.classList.toggle("is-active"),n.classList.contains("is-active")?l.style.overflow="hidden":l.style.overflow=""},i.includes("index")?(o.querySelector(".index").classList.add("header-list__item--active"),c.querySelector(".index").classList.add("header-list__item--active")):i.includes("form")?(console.log(o.querySelector(".form")),o.querySelector(".form").classList.add("header-list__item--active"),c.querySelector(".form").classList.add("header-list__item--active")):i.includes("catalog")&&(o.querySelector(".catalog").classList.add("header-list__item--active"),c.querySelector(".catalog").classList.add("header-list__item--active")),(i.includes("catalog")||i.includes("form"))&&(o.querySelector(".index").classList.add("text-black"),o.querySelector(".form").classList.add("text-black"),o.querySelector(".catalog").classList.add("text-black")),document.querySelector(".catalog-list")),d=[{name:" Cat Energy PRO 500 г",image:"../img/chicken-small-desktop@1x.png",weight:"500 г",taste:"Курица",price:"700 Р."},{name:" Cat Energy PRO 1000 г",image:"../img/chicken-small-desktop@1x.png",weight:"1000 г",taste:"Курица",price:"1000 Р."},{name:" Cat Energy PRO 500 г",image:"../img/fish-small-desktop@1x.png",weight:"500 г",taste:"Рыба",price:"700 Р."},{name:" Cat Energy PRO 1000 г",image:"../img/fish-small-desktop@1x.png",weight:"1000 г",taste:"Рыба",price:"1000 Р."},{name:" Cat Energy PRO 500 г",image:"../img/buckwheat-small-desktop@1x.png",weight:"500 г",taste:"Гречка",price:"400 Р."},{name:" Cat Energy PRO 1000 г",image:"../img/buckwheat-small-desktop@1x.png",weight:"1000 г",taste:"Гречка",price:"700 Р."},{name:" Cat Energy PRO 500 г",image:"../img/rice-small-desktop@1x.png",weight:"500 г",taste:"Рис",price:"500 Р."}];window.addEventListener("click",e=>{if(e.target.classList.contains("show-all"))for(const a of d){if(!r)break;var t=`<div class="catalog-list-card ${700<parseInt(a.weight)?"isbig":""}">
    ...
    </div>`;r.innerHTML+=m}i=document.querySelector(".weight-input"),o=document.querySelector(".age-input");i&&(i.addEventListener("keydown",e=>{["+","-","e"].includes(e.key)&&e.preventDefault()}),i.addEventListener("paste",s)),o&&(o.addEventListener("keydown",e=>{["+","-","e"].includes(e.key)&&e.preventDefault()}),o.addEventListener("paste",s))});